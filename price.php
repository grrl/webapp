...
<div class="w3-top">
  <div class="w3-bar w3-sand w3-card w3-left-align w3-large">
    ...
    <a href="price" class="w3-bar-item w3-button w3-padding-large w3-white">Prices</a>
...
<footer class="w3-container w3-padding-64 w3-center w3-opacity">  
  ...
  <a href="https://www.facebook.com/profile.php?id=100090964571262"><i class="fa fa-facebook-official w3-hover-opacity"></i></a>
 </div>
